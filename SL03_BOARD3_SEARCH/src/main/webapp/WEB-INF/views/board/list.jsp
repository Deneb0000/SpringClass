	...
	<div>
		...
		<table>
			...
			<tbody>
				...
				<form id="searchForm" action="/board/list" method="get"></form>
...
$(function(){
	...
	// 2) 제목을 클릭해서 상세보기 페이지로 이동할 때 +pageNumber, amount값 상세보기에 있는 목록으로 이동하는 링크 태그를 클릭할때
    //    왔던 해당 페이지로 이동
