				...
				<div id="content">
					...
					<div id="notice-article-detail" class="article-detail margin-large" >						
						...
						<div class="article-content" >
							<textarea id="txtContent" class="txtContent" name="content"><img src="http://sstatic.naver.net/keypage/outside/info/2011031017145546407.jpg" /><br />${ notice.content}</textarea>
						</div>						
					</div>
