...
//	private TransactionTemplate transactionTemplate;
	...
	/*
	 * @Override //@Transactional(propagation = Propagation.REQUIRED, isolation =
	 * Isolation.DEFAULT) public void insertAndPointUpOfMember(NoticeVO notice,
	 * String id) throws ClassNotFoundException, SQLException {
	 * 
	 * insert(notice);
	 * 
	 * notice.setTitle(notice.getTitle()+" :two"); insert(notice); }
	 */
